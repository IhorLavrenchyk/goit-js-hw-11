...
var _cardList = require("./js/cardList");
...
function onSearch(e) {
    ...
    (0, _api.fetchArticles)(query, page, perPage).then(({ data  })=>{
        if (data.totalHits === 0) alertNoContentFound();
        else {
            (0, _cardList.createCards)(data.hits);
...
},{"notiflix":"5WWYd","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./js/api":"9u7qN","./js/cardList":"dFpMt"}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
...
async function fetchArticles(query, page, perPage) {
    const res = await (0, _axiosDefault.default).get(`?key=${KEY}&q=${query}&image_type=photo&orientation=horizontal&safesearch=true&page=${page}&per_page=${perPage}`);
    return res;
}
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dFpMt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function createCards(hits) {
    const cards = hits.map((hit)=>{
        const { id , largeImageURL , webformatURL , tags , likes , views , comments , downloads ,  } = hit;
        return `
